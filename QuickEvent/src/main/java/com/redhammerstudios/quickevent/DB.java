...
public class DB extends SQLiteOpenHelper {
    ...
    private static final String KEY_LAST_NAME="las_tname";
    ...
    public void onCreate(SQLiteDatabase db) {
        String CREATE_FRIENDS_TABLE = "CREATE TABLE " + TABLE_FRIENDS + "("
                + KEY_ID + " INTEGER PRIMARY KEY," + KEY_FIRST_NAME+KEY_LAST_NAME + " TEXT,"
                + KEY_PH_NO + " TEXT" + ")";
    ...
    Friend getFriend(int id) {
        ...
        Cursor cursor = db.query(TABLE_FRIENDS, new String[] { KEY_ID,
                KEY_FIRST_NAME,KEY_LAST_NAME, KEY_PH_NO }, KEY_ID + "=?",
